...
<main>
		<div id = 'landingDiv'>
			<h1>A one stop shop!</h1>
			<p>Welcome! We've got what you need</p><br>
			
			<a href = 'login'><button style = "height: 7%;width: 17%"id = 'shop'>Shop Now?</button></a>
		</div>
</main>
