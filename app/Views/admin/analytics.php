...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:21%; padding-left:10px">
		...
		for($j = 0; $j < $length_p; $j++){
			?><label><input type="checkbox" name = "product" value = <?php echo $prodid[$j];?>><?php echo $prod[$j];?></label><br><?php
		}
		?>
...
<main>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">ANALYTICS - Product Purchases
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#remove_filter").click(function(){
			window.location.href = "/clothes/analytics";
		});
            	...
            	success: function(data){
            		...
            		if(data != ''){
               			...
               			for(i = 0; i < data.length; i++){
            				...
            				msg += '<tr><td>'+data[i]["order_id"]+'</td><td>'+data[i]["id"]+'</td><td>'+data[i]['name']+'</td><td>'+data[i]['quantity']+'</td><td>'+data[i]['total']+'</td></tr>';
